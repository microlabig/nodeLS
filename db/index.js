...
const REMOTE_PATH = `mongodb+srv://${process.env.REMOTE_DB_USER}:${REMOTE_PASS}@cluster0-rktdm.mongodb.net/loft?retryWrites=true&w=majority`;
// mongodb+srv://microlabig:<password>@cluster0-rktdm.mongodb.net/test?retryWrites=true&w=majority
